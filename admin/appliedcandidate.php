                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            <div class="box-header well" data-original-title="">
                                <h2><i class="glyphicon glyphicon-user"></i> Student Details</h2>
                                <div class="box-icon">
                            ...
                            <div class="box-content">
                                <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                                    ...
                                    <tbody>
                                        <?php 
                                            $candidateSql = $conn->query("SELECT * FROM applicant LEFT JOIN  registermember on applicant.user_id = registermember.reid WHERE role='candidate' AND jid='".base64_decode($_GET['id'])."'");
                                            while($res = $candidateSql->fetch_object())
                                            {
                                        ?>
                                        <tr>
                                            <td><img src="<?php echo HOME_URL; ?>../profilepic/<?php echo $res->profilepic; ?>" alt="" width="80" height="80"></td>
                                            <td class="center"><?php echo ucfirst($res->fname)." ".ucfirst($res->lname); ?></td>
                                            <td class="center">
                                                <?php echo $res->email; ?>
                                            </td>
                                            <td class="center">
